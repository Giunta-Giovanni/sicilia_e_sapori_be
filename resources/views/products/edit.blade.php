...
<form action="{{ route('products.update', $product) }}" method="POST" class="container mt-4 p-4 border rounded shadow bg-white">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <input 
                type="text" 
                name="name_it" 
                value="{{old('name_it', $product->name_it)}}"
                id="name_it" 
                class="form-control" 
                required>
        @error('name_it')
        ...
        <div class="col-md-6">
            ...
            <input 
                type="text" 
                name="name_eng" 
                value="{{old('name_eng', $product->name_eng)}}"
                id="name_eng" 
                class="form-control" >
            @error('name_eng')
                <div class="invalid-feedback d-block">{{ $message }}</div>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <textarea name="description_it" id="description_it" class="form-control">{{old('description_it', $product->description_it)}}</textarea>
        ...
        <div class="col-md-6">
            ...
            <textarea name="description_eng" id="description_eng" class="form-control">{{old('description_eng', $product->description_eng)}}</textarea>
        ...
        <div class="col-md-6">
            ...
            <div class="input-group mb-3">
                <input 
                    ...
                    value="{{ old('primary_price', $product->primary_price) }}"
                    required>
        ...
        <div class="col-md-6">
            ...
            <div class="input-group mb-3">
                <input 
                    ...
                    id="secondary_price"
                    class="form-control price"
                    value="{{ old('secondary_price', $product->secondary_price ?? null) }}">
                <span class="input-group-text">€</span>
            ...
            <div class="col-sm-6 col-md-2 my-2">
                ...
                <div class="form-check form-check-inline">
                    <input 
                        ...
                        name="is_spicy" 
                        value="1" 
                        {{old('is_spicy', $product->food->is_spicy) == 1?'checked':''}}
                        id="spicy_yes" 
                ...
                <div class="form-check form-check-inline">
                    <input 
                        ...
                        name="is_spicy" 
                        value="0" 
                        {{old('is_spicy', $product->food->is_spicy) == 0?'checked':''}}
                        id="spicy_no" 
                        class="form-check-input"
                        required>
            ...
            <div class="col-sm-6 col-md-2 my-2">
                ...
                <div class="form-check form-check-inline">
                    <input 
                        ...
                        name="is_vegetarian" 
                        value="1" 
                        {{old('is_vegetarian', $product->food->is_vegetarian) == 1?'checked':''}}
                        id="vegetarian_yes" 
                        class="form-check-input"
                        required>
                ...
                <div class="form-check form-check-inline">
                    <input 
                        ...
                        name="is_vegetarian" 
                        value="0" 
                        {{old('is_vegetarian', $product->food->is_vegetarian) == 0?'checked':''}}
                        id="vegetarian_no" 
                        class="form-check-input">
            ...
            <div class="col-md-3">
                ...
                <div class="form-check form-check-inline">
                    <input 
                        ...
                        name="is_alcholic"
                        value="1" 
                        {{old('is_alcholic', $product->beverage->is_alcholic) == 1?'checked':''}}
                        id="is_alcholic_yes" 
                        class="form-check-input"
                        required>
                ...
                <div class="form-check form-check-inline">
                    <input 
                        ...
                        name="is_alcholic"
                        value="0" 
                        {{old('is_alcholic', $product->beverage->is_alcholic) == 0?'checked':''}}
                        id="is_alcholic_no" 
                        class="form-check-input">
            ...
            <div class="col-md-3">
                ...
                <div class="input-group mb-3">
                    <input 
                        ...
                        name="alcohol_volume"
                        id="alcohol_volume"
                        value="{{ old('alcohol_volume', $product->beverage->alcohol_volume)}}"
                        class="form-control input-number "
                        {{ old('is_alcoholic', $product->beverage->alcohol_volume) == 1 ? 'required' : '' }}>
                    <span class="input-group-text">%</span>
            ...
            <div class="col-md-3">
                ...
                <div class="input-group mb-3">
                    <input
                        ...
                        min="0"
                        name="primary_size" 
                        value="{{old('primary_size', $product->beverage->primary_size)}}"
                        id="primary_size" 
                        class="form-control input-number "
                        required>
            ...
            <div class="col-md-3">
                ...
                <div class="input-group mb-3">
                    <input 
                        ...
                        min="0"
                        name="secondary_size" 
                        value="{{old('secondary_size', $product->beverage->secondary_size)}}"
                        id="secondary_size"
                        class="form-control input-number ">
                    <span class="input-group-text">cc</span>
    ...
    <div class="d-flex justify-content-between align-items-center my-4 w-100">
        {{-- Torna indietro --}}
        <a href="{{ route('products.show', $product) }}" class="btn btn-outline-primary shadow-sm">
